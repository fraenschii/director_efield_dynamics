...
% 2025-06-14
% Experiment 1
% blow up example, damping dk=0.5, 
...
expname = 'exp3_blowup_littledamping';
...
figure;quiver(X,Y,Ef(:,:,1,1),Ef(:,:,2,1));
axis image;
ylabel('$y$','rotation',0,'FontSize',16,'Interpreter','LateX')
xlabel('$x$','FontSize',16,'Interpreter','LateX')
ax = gca;
ax.FontSize = 12; 
title(['electric field,T=',num2str(0)])
filename3 = [expname,num2str(0),'_E.fig'];
savefig(filename3);
close(gcf);
