function Afinal = assemble_coeff_stiffness_matrix_homDirichlet(p, t, e, d,eps2,M)
    % Assemble the stiffness matrix with homogeneous Dirichlet bc
    ...
    b_nodes = extract_boundary_nodes(e);
    % Initialize matrices
    A = spalloc(N,N,6*N); 
    ...
    for i = 1:NT
        ...
        A_local = grad_b *(iso+c_matrix)*grad_b';
